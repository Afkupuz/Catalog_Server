...
engine = create_engine('postgresql+psycopg2://catalog:catalog@localhost/mycat')
...
def gconnect():
    ...
    # Upgrade the authorization code into a credentials object
        oauth_flow = flow_from_clientsecrets('/var/www/catalog/secrets/g_client_secrets.json',
                                             scope='')
...
# Verify that the access token is valid for this app.
    CLIENT_ID = json.loads(open('/var/www/catalog/secrets/g_client_secrets.json',
...
def fbconnect():
    ...
    # check secrets
    app_id = json.loads(open('/var/www/catalog/secrets/fb_client_secrets.json', 'r').\
                        read())['web']['app_id']
    app_secret = json.loads(open('/var/www/catalog/secrets/fb_client_secrets.json', 'r').read())['web']['app_secret']
